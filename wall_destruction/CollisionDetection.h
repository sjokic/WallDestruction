...
public:
    ...
    Contact findVertexFaceCollision(const Eigen::Vector3d& vertex,
        ...
        //std::cout << "ret.n is: " << ret.n << std::endl;
        return ret;
    }
    ...
    void compute_a_matrix(Contact contacts[], int ncontacts, Eigen::MatrixXd& a);

    double compute_aij(Contact ci, Contact cj);

    void compute_contact_forces(Contact contacts[], int ncontacts);
